...
print("^0[^2Download^0] ^7:^0 ^5https://github.com/Adiicoo/Menu_Accesoire_Adico^7")
print("^0======================================================================^7")
...
local f5 = {
	Base = { Header = {"commonmenu", "interaction_bgd"}, Color = {color_black}, HeaderColor = {255, 255, 255}, Title = GetPlayerName() },
    ...
    Events = {
        ...
        elseif btn == "Masque" then                                      
                TriggerEvent('RiZiePersoMenu:acces')
	...
	Menu = { 
		["Menu interactions"] = { 
			b = { 
                {name = "Vetements", ask = ">", askX = true}, 
			}
        }
        ["vetements"] = { 
			b = { 
                {name = "Vetements", ask = ">", askX = true}, 
                {name = "Accesoire", ask = ">", askX = true}, 
			}
        },
        ["accesoire"] = { 
			b = { 
                {name = "Masque", ask = ">", askX = true}, 
                {name = "Accesoire", slidemax = accesoire}, 
			}
        }
